...
const pillars = [
  {
    ...
    tag: "COMUNIDAD",
    name: "TRAINO BOX",
    hook: "Crea el hábito y recupera tu energía",
    description:
      "Coaching de élite, comunidad que empuja y WODs diarios que desafían. Para quienes se superan en equipo.",
    features: [
      "Coaching certificado en cada clase",
      "WODs programados y escalables",
  ...
  },
  {
    ...
    tag: "LIBERTAD",
    name: "TRAINO GYM",
    hook: "Entrena bajo tus propias reglas",
    description:
    ...
    <Section className="relative overflow-hidden bg-zinc-950 py-28">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            TRES PILARES.{" "}
            <span className="text-primary">UN SISTEMA.</span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {pillars.map((pillar, i) => (
            ...
            >
              <div
                className={`relative h-full flex flex-col overflow-hidden border transition-all duration-500 group ${
                  pillar.highlighted
